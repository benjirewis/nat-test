// Package main defines a CLI tool that takes no arguments and runs network checks.
package main
...
func main() {
	...
	// TODO: Take some command-line arguments.
	utils.ContextualMain(runNetworkChecks, logger)
}
...
func runNetworkChecks(ctx context.Context, _ []string, rdkLogger logging.Logger) error {
...
var (
	// TODO: Attempt raw IPs of STUN server URLs in the event that DNS resolution does not
	// work.
...
func sendUDPBindRequest(
	...
	if !exists {
		...
		if err != nil {
			// TODO: Attempt raw IPs of STUN server URLs in the event that DNS resolution does
			// not work.
